...
**Markdown** es un lenguaje de marcado de texto, al igual que **HTML**. Sin embargo, es extremadamente fácil de usar (por eso lo de avanzado :wink:). En este `README`, te explico cómo usar Markdown.
